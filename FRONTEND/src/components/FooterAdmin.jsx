            ...
            <div className="footer-container">
                ...
                <div className="footer-section links-section">
                    ...
                    <ul className="footer-links">
                        <li>
                            <a href="/Tableau de board">Tableau de bord</a>
                        </li>
                        <li>
                            <a href="/Gestion des artisans">Gestion des artisans</a>
                        </li>
                        <li>
                            <a href="/Catalogue">Catalogue</a>
                        </li>
                        <li>
                            <a href="/Gestion des commandes" className="nav-link">Gestion des commandes</a>
                        </li>
                        <li>
                            <a href="/Avis & Réclamations">Avis & Réclamations</a>
                        </li>
